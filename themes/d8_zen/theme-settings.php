 ...
 */
function d8_zen_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['d8_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('d8_zen sample setting'),
  '#default_value' => theme_get_setting('d8_zen_example'),
